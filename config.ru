          ...
          <section class='col-xs-12 col-sm-6 col-md-6'>
            <section>
              <h2>Deploying code changes</h2>
                <p>
                  The source code for this application is available to be forked from the <a href="https://github.com/lebrun-cyril/ruby-ex"> Cyrill Lebrun GitHub repository</a>.
